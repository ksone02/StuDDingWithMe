...
(function(factory) {
    ...
    var Sammy, PATH_REPLACER = "([^/]+)", PATH_NAME_MATCHER = /:([\w\d]+)/g, QUERY_STRING_MATCHER = /\?([^#]*)?$/, _makeArray = function(nonarray) {
    ...
    Sammy.Application.prototype = $.extend({}, Sammy.Object.prototype, {
        ...
        runRoute: function(verb, path, params, target) {
            var app = this, route = this.lookupRoute(verb, path), context, wrapped_route, arounds, around, befores, before, callback_args, path_params, final_returned;
            if (this.debug) {
        ...
        contextMatchesOptions: function(context, match_options, positive) {
            ...
            if (_isArray(options.path)) {
                ...
                results = [];
                for (numopt = 0,
                len = options.path.length; numopt < len; numopt += 1) {
                    opts = $.extend({}, options, {
